...
public interface IUafClientUtils {
    /**
     * Gets an intent which will perform a UAF Registration, Authentication or DeregistrationEbayFIDOServerImpl operation using the UAF client app.
     * @param fidoOpType FIDO UAF operation type (Registration, Authentication, DeregistrationEbayFIDOServerImpl)
     ...
     * DiscoveryData for a Discovery operation. DeregistrationEbayFIDOServerImpl and Check Policy operations return null.
